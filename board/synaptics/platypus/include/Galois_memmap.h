...
///                            ###
///                            * Reserved (space to map Galois DDR to PCIe host. This is from the
///                            * PCIe host point of view. So this space COULD still be used by
///                            * Galois CPU, but intentionally left blank to avoid causing any
///                            * confusion)
///                            * 256 MB
///                            * **INTERNAL_ONLY**
///                            ###
...
///                            * 32 MB (depends on the configuration)
///                            * 100M AHB
///                            ###
...
///                            ###
///                            * 100MHz AHB
///                            * all on-chip devices not listed in “Fast Register” section,
///                            * minimal 64k Byte space for each
///                            * The base address will equal with the last slow register section
///                            * base
...
///                            * 1MB
///                            ###
///               : V4G_REG_SIZE       0x100000
///                            ###
///                            * Size of V4G Registers
///                            ###
///               : V4G_REG_DEC_BIT    0x14
///                            ###
...
///                            * 64KB has 16-bit offset
///                            ###
///               : GEOXBAR_REG_BASE   0xF78D0000
///                            ###
///                            * Base address of GEOXBAR Registers
///                            * 32KB
///                            ###
///               : GEOXBAR_REG_SIZE   0x8000
///                            ###
///                            * Size of GEOXBAR registers
///                            ###
///               : GEOXBAR_REG_DEC_BIT 0xF
///                            ###
///                            * 32KB has 15bit offset
///                            ###
///               : GEOX_ADD_CTRL_REG_BASE 0xF78D0000
///                            ###
///                            * Base address for GEOXBar address control registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_ADD_CTRL_REG_SIZE 0x1000
///                            ###
///                            * Size of GEOXBar address control registers
///                            ###
///               : GEOX_ADD_CTRL_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : GEOX_PERIPH_ID_REG_BASE 0xF78D1000
///                            ###
///                            * Base address for GEOXBar periphal ID registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_PERIPH_ID_REG_SIZE 0x1000
///                            ###
///                            * Size of GEOXBar periphal ID registers
///                            ###
///               : GEOX_PERIPH_ID_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : GEOX_OUT_REG_BASE  0xF78D2000
///                            ###
///                            * Base address for GEOXBar output interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_OUT_REG_SIZE  0x1000
///                            ###
///                            * Size of GEOXBar output interface registers
///                            ###
///               : GEOX_OUT_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : GEOX_OVP_REG_BASE  0xF78D3000
///                            ###
///                            * Base address for GEOXBar OVP interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_OVP_REG_SIZE  0x1000
///                            ###
///                            * Size of GEOXBar OVP interface registers
///                            ###
///               : GEOX_OVP_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : GEOX_GFX_REG_BASE  0xF78D4000
///                            ###
///                            * Base address for GEOXBar GFX interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_GFX_REG_SIZE  0x1000
///                            ###
///                            * Size of GEOXBar GFX interface registers
///                            ###
///               : GEOX_GFX_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : GEOX_ENC_REG_BASE  0xF78D5000
///                            ###
///                            * Base address for GEOXBar ENCODER interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : GEOX_ENC_REG_SIZE  0x1000
///                            ###
///                            * Size of GEOXBar ENCODER interface Registers
///                            ###
///               : GEOX_ENC_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : VNXBAR_REG_BASE    0xF78E0000
///                            ###
///                            * Base address of VNXBAR Registers
///                            * 32KB
///                            ###
///               : VNXBAR_REG_SIZE    0x8000
///                            ###
///                            * Size of VNXBAR registers
///                            ###
///               : VNXBAR_REG_DEC_BIT 0xF
///                            ###
///                            * 32KB has 15bit offset
///                            ###
///               : VNX_ADD_CTRL_REG_BASE 0xF78E0000
///                            ###
///                            * Base address for VNXBar address control registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : VNX_ADD_CTRL_REG_SIZE 0x1000
///                            ###
///                            * Size of VNXBar address control registers
///                            ###
///               : VNX_ADD_CTRL_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : VNX_PERIPH_ID_REG_BASE 0xF78E1000
///                            ###
///                            * Base address for VNXBar periphal ID registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : VNX_PERIPH_ID_REG_SIZE 0x1000
///                            ###
///                            * Size of VNXBar periphal ID registers
///                            ###
///               : VNX_PERIPH_ID_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : VNX_OUT_REG_BASE   0xF78E2000
///                            ###
///                            * Base address for VNXBar output interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : VNX_OUT_REG_SIZE   0x1000
///                            ###
///                            * Size of VNXBar output interface registers
///                            ###
///               : VNX_OUT_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : VNX_V4G_REG_BASE   0xF78E3000
///                            ###
///                            * Base address for VNXBar V4G interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : VNX_V4G_REG_SIZE   0x1000
///                            ###
///                            * Size of VNXBar V4G interface registers
///                            ###
///               : VNX_V4G_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
///               : VNX_NPU_REG_BASE   0xF78E4000
///                            ###
///                            * Base address for VNXBar NPU interface registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : VNX_NPU_REG_SIZE   0x1000
///                            ###
///                            * Size of VNXBar NPU interface Registers
///                            ###
///               : VNX_NPU_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12 bits offset
///                            ###
...
///                            * Address decoding bit
///                            ###
///               : USIM0_REG_DEC_BIT  0x7
///                            ###
///                            * 128B has 7-bit offset
...
///                            ###
///               : GEOXBAR_ALM_REG_BASE 0xF7A80000
///                            ###
///                            * Base address for Axi Latency meter in GEOXBAR
///                            * 64 KB
///                            ###
///               : GEOXBAR_ALM_REG_SIZE 0x10000
///                            ###
///                            * Size of  GEOXBAR ALM Registers memory mapping
///                            ###
///               : GEOXBAR_ALM_REG_DEC_BIT 0x10
///                            ###
///                            * 64 KB has a 16 bits offset
///                            ###
///               : VNXBAR_ALM_REG_BASE 0xF7A90000
///                            ###
///                            * Base address for Axi Latency meter in VNXBAR
///                            * 64 KB
///                            ###
///               : VNXBAR_ALM_REG_SIZE 0x10000
///                            ###
///                            * Size of  VNXBAR ALM Registers memory mapping
///                            ###
///               : VNXBAR_ALM_REG_DEC_BIT 0x10
///                            ###
///                            * 64 KB has a 16 bits offset
...
///                            ###
///                            * 4KB has 12-bit offset
///                            * Memory map for SL2C (System L2 Cache) registers inside PJ4B-MP
///                            * sub-system
///                            ###
...
///                            * 64KB has 16-bit offset
///                            ###
///               : SDIO3_1_REG_BASE   0xF7B80000
///                            ###
///                            * Base address for SDIO1 Registers
///                            * 4KB
///                            * **INTERNAL_ONLY**
///                            ###
///               : SDIO3_1_REG_SIZE   0x1000
///                            ###
///                            * Size of SDIO1 Registers
///                            ###
///               : SDIO3_1_REG_DEC_BIT 0xC
///                            ###
///                            * 4KB has 12-bit offset
///                            ###
...
///                            ###
///               : DSP0_REG_BASE      0xF9040000
///                            ###
///                            * Base address of HIFI4 DSP0 control Registers
///                            * 64 KB
///                            ###
///               : DSP0_REG_SIZE      0x10000
///                            ###
///                            * Size of HIFI4 DSP0 Registers memory mapping
///                            ###
///               : DSP0_REG_DEC_BIT   0x10
///                            ###
///                            * 64 KB has a 16 bits offset
///                            ###
///               : DSP1_REG_BASE      0xF9050000
///                            ###
///                            * Base address of HIFI4 DSP1 control Registers
///                            * 64 KB
///                            ###
///               : DSP1_REG_SIZE      0x10000
///                            ###
///                            * Size of HIFI4 DSP1 Registers memory mapping
///                            ###
///               : DSP1_REG_DEC_BIT   0x10
///                            ###
///                            * 64 KB has a 16 bits offset
///                            ###
...
///                            ###
///                            * The first instruction address after resetting
...
#define h_MEMMAP () {}
    ...
    #define        MEMMAP_H1_REG_SIZE                          0x1000
    #define        MEMMAP_H1_REG_DEC_BIT                       0xC
    ...
    #define        MEMMAP_V4G_REG_SIZE                         0x100000
    #define        MEMMAP_V4G_REG_DEC_BIT                      0x14
    ...
    #define        MEMMAP_GEOXBAR_REG_BASE                     0xF78D0000
    #define        MEMMAP_GEOXBAR_REG_SIZE                     0x8000
    #define        MEMMAP_GEOXBAR_REG_DEC_BIT                  0xF
    #define        MEMMAP_GEOX_ADD_CTRL_REG_BASE               0xF78D0000
    #define        MEMMAP_GEOX_ADD_CTRL_REG_SIZE               0x1000
    #define        MEMMAP_GEOX_ADD_CTRL_REG_DEC_BIT            0xC
    #define        MEMMAP_GEOX_PERIPH_ID_REG_BASE              0xF78D1000
    #define        MEMMAP_GEOX_PERIPH_ID_REG_SIZE              0x1000
    #define        MEMMAP_GEOX_PERIPH_ID_REG_DEC_BIT           0xC
    #define        MEMMAP_GEOX_OUT_REG_BASE                    0xF78D2000
    #define        MEMMAP_GEOX_OUT_REG_SIZE                    0x1000
    #define        MEMMAP_GEOX_OUT_REG_DEC_BIT                 0xC
    #define        MEMMAP_GEOX_OVP_REG_BASE                    0xF78D3000
    #define        MEMMAP_GEOX_OVP_REG_SIZE                    0x1000
    #define        MEMMAP_GEOX_OVP_REG_DEC_BIT                 0xC
    #define        MEMMAP_GEOX_GFX_REG_BASE                    0xF78D4000
    #define        MEMMAP_GEOX_GFX_REG_SIZE                    0x1000
    #define        MEMMAP_GEOX_GFX_REG_DEC_BIT                 0xC
    #define        MEMMAP_GEOX_ENC_REG_BASE                    0xF78D5000
    #define        MEMMAP_GEOX_ENC_REG_SIZE                    0x1000
    #define        MEMMAP_GEOX_ENC_REG_DEC_BIT                 0xC
    #define        MEMMAP_VNXBAR_REG_BASE                      0xF78E0000
    #define        MEMMAP_VNXBAR_REG_SIZE                      0x8000
    #define        MEMMAP_VNXBAR_REG_DEC_BIT                   0xF
    #define        MEMMAP_VNX_ADD_CTRL_REG_BASE                0xF78E0000
    #define        MEMMAP_VNX_ADD_CTRL_REG_SIZE                0x1000
    #define        MEMMAP_VNX_ADD_CTRL_REG_DEC_BIT             0xC
    #define        MEMMAP_VNX_PERIPH_ID_REG_BASE               0xF78E1000
    #define        MEMMAP_VNX_PERIPH_ID_REG_SIZE               0x1000
    #define        MEMMAP_VNX_PERIPH_ID_REG_DEC_BIT            0xC
    #define        MEMMAP_VNX_OUT_REG_BASE                     0xF78E2000
    #define        MEMMAP_VNX_OUT_REG_SIZE                     0x1000
    #define        MEMMAP_VNX_OUT_REG_DEC_BIT                  0xC
    #define        MEMMAP_VNX_V4G_REG_BASE                     0xF78E3000
    #define        MEMMAP_VNX_V4G_REG_SIZE                     0x1000
    #define        MEMMAP_VNX_V4G_REG_DEC_BIT                  0xC
    #define        MEMMAP_VNX_NPU_REG_BASE                     0xF78E4000
    #define        MEMMAP_VNX_NPU_REG_SIZE                     0x1000
    #define        MEMMAP_VNX_NPU_REG_DEC_BIT                  0xC
    ...
    #define        MEMMAP_USIM0_REG_SIZE                       0x80
    #define        MEMMAP_USIM0_REG_DEC_BIT                    0x7
    ...
    #define        MEMMAP_GEOXBAR_ALM_REG_BASE                 0xF7A80000
    #define        MEMMAP_GEOXBAR_ALM_REG_SIZE                 0x10000
    #define        MEMMAP_GEOXBAR_ALM_REG_DEC_BIT              0x10
    #define        MEMMAP_VNXBAR_ALM_REG_BASE                  0xF7A90000
    #define        MEMMAP_VNXBAR_ALM_REG_SIZE                  0x10000
    #define        MEMMAP_VNXBAR_ALM_REG_DEC_BIT               0x10
    ...
    #define        MEMMAP_SDIO3_1_REG_BASE                     0xF7B80000
    #define        MEMMAP_SDIO3_1_REG_SIZE                     0x1000
    #define        MEMMAP_SDIO3_1_REG_DEC_BIT                  0xC
    ...
    #define        MEMMAP_DSP0_REG_BASE                        0xF9040000
    #define        MEMMAP_DSP0_REG_SIZE                        0x10000
    #define        MEMMAP_DSP0_REG_DEC_BIT                     0x10
    #define        MEMMAP_DSP1_REG_BASE                        0xF9050000
    #define        MEMMAP_DSP1_REG_SIZE                        0x10000
    #define        MEMMAP_DSP1_REG_DEC_BIT                     0x10
